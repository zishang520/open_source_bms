                ...
                <form class="layui-form form-container" action="{{ url('admin/article/update') }}" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <input type="radio" name="status" value="0" title="未审核" @if($article['status']==0) checked="checked"@endif>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">置顶</label>
                        <div class="layui-input-block">
                            <input type="radio" name="is_top" value="1" title="置顶" @if($article['is_top']==1) checked="checked"@endif>
