                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="pid" lay-verify="required">
                                ...
                                <option value="{{ $vo['id'] }}" @if($category['id']==$vo['id']) disabled="disabled"@endif @if($category['pid']==$vo['id']) selected="selected"@endif>{neq name="vo.level" value="1"}|{php}for($i=1;$i<$vo['level'];$i++){echo ' ----';}{/php}{/neq} {{ $vo['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
