                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="pid" required lay-verify="required">
                                ...
                                <option value="{{ $vo['id'] }}" @if($nav['id']==$vo['id']) disabled="disabled"@endif @if($nav['pid']==$vo['id']) selected="selected"@endif>{neq name="vo.level" value="1"}|{php}for($i=1;$i<$vo['level'];$i++){echo ' ----';}{/php}{/neq} {{ $vo['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
